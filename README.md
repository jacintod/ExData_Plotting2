...
PM2.5 Emissions Data (_.): This file contains a data frame with all of the PM2.5 emissions data for 1999, 2002, 2005, and 2008. For each year, the table contains number of tons of PM2.5 emitted from a specific type of source for the entire year. Here are the first few rows.
...
You can read each of the two files using the () function in R. For example, reading in each file can be done with the following code:
